...
export class LicencePerClientController {
  constructor(private readonly licencePerClientService: LicencePerClientService) {}
  ...
  create(
    ...
    return this.licencePerClientService.create(req.user, createLicencePerClientDto);
  }
  ...
  @Patch(':id')
  @UseGuards(JwtAuthGuard)
  update(@Param('id') id: string, @Body() updateLicencePerClientDto: UpdateLicencePerClientDto) {
